...
class FunctionsTest {
    ...
    @Test
    void getListOfNumberBy(){
        assertEquals(Functions.getListOfNumberBy(1, 10, 2), Arrays.asList(1, 3, 5, 7, 9));
        assertEquals(Functions.getListOfNumberBy(2, 14, 3), Arrays.asList(2, 5, 8, 11, 14));
    }

    @Test
    void makeArrayFromMatrix(){
        List<List<Integer>> list = Arrays.asList(Arrays.asList(1, 2, 3), Arrays.asList(4, 5, 6), Arrays.asList(7, 8, 9));
        assertEquals(Functions.makeArrayFromMatrix(list), Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9));
    }
}